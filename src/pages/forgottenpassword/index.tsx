									...
									<div className='flex flex-col gap-8'>
										<div className='flex flex-col gap-1'>
											<Field
												...
												className='p-4 rounded-xl border-2 focus:outline-none focus:border-secondaryBlue'
											/>
											<ErrorMessage className='text-errorRed' name='email' component='p' />
										</div>

										<button
											disabled={isLoading || !isValid}
											className='p-4 bg-primary300 text-white text-lg font-semibold rounded-2xl border-2 hover:border-primary400 focus:outline-none disabled:cursor-not-allowed'
										>
